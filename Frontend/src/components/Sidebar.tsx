    ...
    return (
        <div className="bg-dark
            ...
            {token ? (
                ...
                <NavLink to={'/login'} className="flex items-center gap-2 hover:bg-neutral-400/20 transition duration-200 rounded-md p-3 sm:w-full">
                    <img className='size-7 sm:size-6' src={messageIcon} />
                    <p className='font-semibold hidden lg:block text-lg'>Chats</p>
                </NavLink>
            )}
            {token ? (
                ...
                <NavLink to={'/login'} className="flex items-center gap-2 hover:bg-neutral-400/20 transition duration-200 rounded-md p-3">
                    <img className='size-7 sm:size-6' src={groupIcon} />
                    <p className='font-semibold hidden lg:block text-lg'>Groups</p>
                </NavLink>
            )}
